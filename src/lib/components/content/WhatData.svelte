...
<div class="my-8 md:grid md:grid-cols-2 md:grid-rows-2 xl:grid-cols-4 xl:grid-rows-1 gap-3">
	...
	<Callout>
		...
		<p class="mt-0">Technology Carbon Standard (TCS) carbon emission estimates are based on categorised mappings of an organisation's use of digital and be shared as structured JSON data.</p>
	</Callout>
</div>
