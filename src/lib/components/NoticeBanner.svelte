<div class="border-2 border-dark-gray alert__warning text-center p-4">
	<p class="text-sm sm:text-base">
		...
		<br /><a href="https://www.thegreenwebfoundation.org/tools/carbon-txt" title="Introducing carbon.txt – Applying lessons from crowdsourcing net zero data">Read more</a>
	</p>
</div>
