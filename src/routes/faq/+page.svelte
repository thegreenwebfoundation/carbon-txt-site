...
<article class="container mx-auto pt-6 md:pt-8 px-2 sm:px-4">
	...
	<Faq id="developer-tools">
      ...
      <details class="mb-4 ml-4">
        ...
        <p>API documentation is available at <a href="https://carbon-txt-api.greenweb.org/api/docs" target="_blank">carbon-txt-api.greenweb.org/api/docs</a>, and further information and usage examples on our <a href="https://developers.thegreenwebfoundation.org/carbon-txt/overview/" target="_blank">developer documentation site</a>. To access this API you will need to register for an API key on the <a href="https://admin.thegreenwebfoundation.org" target="_blank">Green Web portal</a>, and pass it in the <code>X-API-Key</code> header of your API requests. By default, requests are rate-limited to 2 per second per key - if you need a higher limit, please <a href="mailto:support@greenweb.org?subject=Raise%20API%20key%20request%20limit">get in touch</a> to discuss your use case!</p>
