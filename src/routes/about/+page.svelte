	...
	<article class="container mx-auto pt-6 md:pt-8 px-2 sm:px-4">
		...
		<section id="why" class="w-100 mb-[10rem]">
			...
			<div class="prose">
				<p>
					...
					database, open sources the code for tracking this and is publishing open datasets about
					the state of the green web.
				</p>
				<p>
					Creating this dataset has been an ongoing effort for years. It has comprised of
					associating IP address space like IP ranges or Autonomous System Numbers with specific
					organisations - and then accompanying these links to manually verified written reports and
					certificates provided by said organisations to back up their green claims.
				</p>

				<p>
					This has worked for the first few million domains, and first few billion checks against
					the database, but there are more tools that can help now, and the internet is a much
					bigger, more dynamic place than it was when this endeavour was started.
				</p>

				<p>
					Tools like the domain name system (DNS) allow for a variety of ways to establish a link
					between a domain and the party that is hosting or operating it. Dedicated registries
					already exist to make it possible to trust that electricity has been generated from clean
					and renewable energy sources. And, if you know where to look, it's possible to tell when
					efforts to decarbonise energy are credible.
				</p>
		...
		<section id="goals" class="w-100 mb-[10rem] grid grid-cols-1 gap-10">
			...
			<div class="prose">
				<ul>
					<li>
						used as much existing infrastructure as possible (web standards, conventions,
						governance)
					</li>
					<li>
						applied permissive licensing around use, so it can easily be built into modern tooling
						for continuous delivery and existing platforms/software;
					</li>
			...
			<div class="prose">
				...
				<ul>
					...
					<li>
						...
						providers to help the world transition to a fossil free internet.
					</li>
					<li>
						Allow any downstream services or websites using your services to make the same claims,
				...
				<ul>
					...
					<li>
						Help build the evidence base for tracking the transition of to a fossil free internet.
