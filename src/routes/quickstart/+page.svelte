			...
			<li class="border-t border-gray-400 pb-[3rem]">
				<div class="mt-[2rem]">
					...
					<div class="prose mb-[2rem]]">
						...
						<p>
							Upload the carbon.txt file to a <code>/.well-known/</code> path on your server. This follows existing conventions that web administrators
